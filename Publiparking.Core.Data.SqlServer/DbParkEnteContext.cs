...
{
    public partial class DbParkContext
    {
        ...
        private static Dictionary<Type, System.Data.Entity.Core.Metadata.Edm.EntitySetBase> _mappingCache = new Dictionary<Type, System.Data.Entity.Core.Metadata.Edm.EntitySetBase>();
        ...
        /// </summary>
        /// <returns></returns>
        public List<Microsoft.EntityFrameworkCore.ChangeTracking.EntityEntry> getListOfInvalid()
        {
            // --- Se _bValidateEntities==false non valida! ---
            List<Microsoft.EntityFrameworkCore.ChangeTracking.EntityEntry> v_invalidList = _bValidateEntities ?
                    (from a in this.ChangeTracker.Entries().Where(a => a.State == EntityState.Modified || a.State == EntityState.Added)
                     where (a.Entity is IValidator && !(a.Entity as IValidator).IsValid)
                     select a).ToList()
                     : EmptyListOfInvalid;
            return v_invalidList;
        }
        public DbParkContext(string p_connectionstring, int p_idstruttura, int p_idrisorsa, bool p_isReadOnly = false)
        {
        ...
        public DbParkContext(string p_connectionstring, bool p_isReadOnly = false)
        {
            //Salva i valori di default
            _isReadOnly = p_isReadOnly;
            _connectionstring = p_connectionstring;
        ...
        {
            List<Microsoft.EntityFrameworkCore.ChangeTracking.EntityEntry> v_invalidList = getListOfInvalid();
            SetUserStatus(v_invalidList);
        }
        public void SetUserStatus(List<Microsoft.EntityFrameworkCore.ChangeTracking.EntityEntry> v_invalidList)
        {
        ...
        private readonly static List<Microsoft.EntityFrameworkCore.ChangeTracking.EntityEntry> EmptyListOfInvalid = new List<Microsoft.EntityFrameworkCore.ChangeTracking.EntityEntry>();
            ...
            foreach (var entry in ChangeTracker.Entries())
            {
                switch (entry.State)
                {
                    case EntityState.Added:
                        entry.CurrentValues["flag_on_off"] = "1";
                        break;
                    case EntityState.Deleted:
                        entry.State = EntityState.Modified;
                        entry.CurrentValues["flag_on_off"] = "0";
                        break;
                }
            }
        }
        ...
        {
            System.Data.Entity.Core.Metadata.Edm.EntitySetBase v_entity = GetEntitySet(v_type);
        ...
        /// <returns></returns>
        private System.Data.Entity.Core.Metadata.Edm.EntitySetBase GetEntitySet(Type v_type)
        {

            if (!_mappingCache.ContainsKey(v_type))
            {
                System.Data.Entity.Core.Objects.ObjectContext v_octx = ((System.Data.Entity.Infrastructure.IObjectContextAdapter)this).ObjectContext;

                string v_typeName = System.Data.Entity.Core.Objects.ObjectContext.GetObjectType(v_type).Name;
                System.Data.Entity.Core.Metadata.Edm.EntitySetBase v_baseEntity = v_octx.MetadataWorkspace.GetItemCollection(System.Data.Entity.Core.Metadata.Edm.DataSpace.SSpace)
        ...
        private void OnDbEntityValidationException(System.Data.Entity.Validation.DbEntityValidationException dbEx)
        {
        ...
        private int SetStatus(List<Microsoft.EntityFrameworkCore.ChangeTracking.EntityEntry> v_invalidList)
        {
            //Aggiorna i campi per saper chi ha apportato le modifiche alle entità (Solo se sono stati indicati risorsa e struttura di default)
            //if (_idStruttura > 0 && _idRisorsa > 0)
            //{
        ...
        private void SoftDelete(Microsoft.EntityFrameworkCore.ChangeTracking.EntityEntry p_entry)
        {
            ...
            //    DbParkContext..ExecuteSqlCommand(v_sql, new SqlParameter("@id", p_entry.OriginalValues[GetPrimaryKeyName(v_entryEntityType)]));
            //}
        ...
        //    return v_invalidList;
        //}
        public List<Microsoft.EntityFrameworkCore.ChangeTracking.EntityEntry> getListOfInvalidOrThrow(bool forceIgnoreInvalidList)
        {
            List<Microsoft.EntityFrameworkCore.ChangeTracking.EntityEntry> v_invalidList = forceIgnoreInvalidList ? EmptyListOfInvalid : getListOfInvalid();
            if (v_invalidList.Count > 0)
            {
