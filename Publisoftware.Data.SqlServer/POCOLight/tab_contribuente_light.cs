...
{
    public class tab_contribuente_light
    {
        ...
        public string tipologiaContribuente { get; set; }
        public bool isPersonaFisica { get; set; }
        public string indirizzoTotaleDisplay { get; set; }
        public string relazione { get; set; }
        public string data_nas_String { get; set; }
        public string indirizzoDisplay { get; set; }
        public string civico { get; set; }
        public string cittaDisplay { get; set; }
    }
}
