...
{
    public class tab_fascicolo_doc_output_allegati_light : BaseEntity<tab_fascicolo_doc_output_allegati_light>
    {
        ...
        public bool IsDocOutputImmagine { get; set; }
        ...
        public string barcodeDocOutput { get; set; }
