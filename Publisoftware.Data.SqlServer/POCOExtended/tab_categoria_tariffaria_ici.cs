...
{
    [MetadataTypeAttribute(typeof(tab_categoria_tariffaria_ici.Metadata))]
    public partial class tab_categoria_tariffaria_ici : ISoftDeleted, IValidatableObject
    {

        public List<ValidationResult> validationErrors()
        {
            TypeDescriptor.AddProviderTransparent(new AssociatedMetadataTypeTypeDescriptionProvider(typeof(tab_categoria_tariffaria_ici),
                typeof(tab_categoria_tariffaria_ici.Metadata)), typeof(tab_categoria_tariffaria_ici));
        ...
        internal sealed class Metadata
        {
            ...
            [DisplayName("ID")]
            public int id_categoria_tariffaria_ici { get; set; }
