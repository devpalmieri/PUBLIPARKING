...
namespace Publisoftware.Data
{
    ...
    public partial class tab_calcolo_tipo_voci_contribuzione
    {
        public int id_tab_calcolo_tipo_voci_contribuzione { get; set; }
        ...
        public string modalita_calcolo { get; set; }
        public Nullable<decimal> aliquota_calcolo { get; set; }
        public Nullable<decimal> importo_fisso { get; set; }
        public Nullable<decimal> importo_da_pagare_minimo { get; set; }
        public Nullable<decimal> importo_da_pagare_massimo { get; set; }
        public string um_voce_contribuzione { get; set; }
        public string flag_segno { get; set; }
        public Nullable<bool> flag_iva { get; set; }
