...
namespace Italia.Spid.Authentication
{
    public static class SpidUserInfoHelper
    {
        ...
        public static string SpidCode(Dictionary<string, string> spidUserInfo)
        {
            try
            {
                return spidUserInfo["spidCode"];
            }
            catch
            {
                return "N/A";
        ...
        public static string DateOfBirth(Dictionary<string, string> spidUserInfo)
        {
            try
            {
                return spidUserInfo["dateOfBirth"];
            }
            catch
            {
                return "N/A";
        ...
        public static string IvaCode(Dictionary<string, string> spidUserInfo)
        {
            try
            {
                return spidUserInfo["ivaCode"];
            }
            catch
            {
                return "N/A";
        ...
        public static string Mobile(Dictionary<string, string> spidUserInfo)
        {
            try
            {
                return spidUserInfo["mobilePhone"];
            }
            catch
            {
                return "N/A";
