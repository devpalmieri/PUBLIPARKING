...
namespace Publiparking.Data.BD
{
    ...
    public abstract class EntityBD<EntityType> where EntityType : class
    {
        ...
        /// <returns></returns>
        protected static IQueryable<EntityType> GetListInternal(DbParkCtx p_dbContext, IEnumerable<string> p_includeEntities = null)
        {
        ...
        /// <param name="p_includeEntities">Elenco di tabelle collegate da includere durante la select</param>
        /// <returns></returns>
        public static IQueryable<EntityType> GetList(DbParkCtx p_dbContext, IEnumerable<string> p_includeEntities = null)
        {
        ...
        /// <param name="p_dbContext">Context di esecuzione</param>
        /// <returns></returns>
        public static DbRawSqlQuery<EntityType> GetList(string p_sql, DbParkCtx p_dbContext)
        {
        ...
        /// <param name="p_dbContext">Context di esecuzione</param>
        /// <returns></returns>
        public static DbRawSqlQuery<EntityType> GetList(string p_sql, SqlParameter[] p_params, DbParkCtx p_dbContext)
        {
        ...
        /// <param name="p_dbContext">Context di esecuzione</param>
        /// <returns></returns>
        public static EntityType GetById(Int32 p_id, DbParkCtx p_dbContext)
        {
        ...
        /// <param name="p_dbContext">Context di esecuzione</param>
        /// <returns></returns>
        public static EntityType GetById(Decimal p_id, DbParkCtx p_dbContext)
        {
        ...
        /// <param name="p_dbContext">Context di esecuzione</param>
        /// <returns></returns>
        public static EntityType GetByIdDetached(Int32 p_id, DbParkCtx p_dbContext)
        {
