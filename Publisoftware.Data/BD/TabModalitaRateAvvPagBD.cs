...
{
    public class TabModalitaRateAvvPagBD : EntityBD<tab_modalita_rate_avvpag>
    {
        public TabModalitaRateAvvPagBD()
        {

        }

        public static IQueryable<tab_modalita_rate_avvpag> QueryByIdTipoAvvPagAndIdEnte(int p_idTipoAvvPag, int p_idEnte, dbEnte dbContext)
        {
        ...
        public static tab_modalita_rate_avvpag GetByIdTipoAvvPagAndIdEnte(int p_idTipoAvvPag, int p_idEnte, dbEnte dbContext)
        {
            return GetList(dbContext).Where(j => j.id_tipo_avv_pag == p_idTipoAvvPag)
                                     .Where(j => j.id_ente == p_idEnte)
                                     .WhereByRangeValiditaOdierno()
        ...
        /// <returns></returns>
        public static tab_modalita_rate_avvpag GetByIdTipoAvvPagAndIdEnteAndRange(int p_idTipoAvvPag, int p_idEnte, dbEnte dbContext)
        {
            return GetList(dbContext).Where(j => j.id_tipo_avv_pag == p_idTipoAvvPag)
                                     .Where(j => j.id_ente == p_idEnte)
                                     .WhereByRangeValiditaOdierno()
        ...
        /// <param name="dbContext"></param>
        /// <returns></returns>
        public static tab_modalita_rate_avvpag GetByIdTipoAvvPagAndIdEnteGestitoForSpecificDate(int p_idTipoAvvPag, int p_idEnte, DateTime p_ValidInDate, dbEnte dbContext)
        {
        ...
        public static IQueryable<tab_modalita_rate_avvpag> GetByIdTipoAvvPagAndIdEnteGestito(int p_idTipoAvvPag, int p_idEnte, int p_idEnteGestito, dbEnte dbContext)
        {
            return GetList(dbContext).Where(j => j.id_tipo_avv_pag == p_idTipoAvvPag)
                                     .Where(j => j.id_ente == p_idEnte)
        ...
        {
            tab_modalita_rate_avvpag v_modalita = GetList(dbContext).WhereByIdTipoAvvPag(p_idTipoAvviso).FirstOrDefault();
            ...
            {
                if (v_modalita.GG_scadenza_pagamento == 1)
                {
                    v_decorrenza = "Dal giorno successivo alla data di notifica.";
                }
                else
                {
                    v_decorrenza = v_modalita.GG_scadenza_pagamento + " giorni a decorrere dalla data di notifica.";
                }
            }
            else if (v_modalita != null)
            {
                ...
                {
                    v_decorrenza = v_modalita.GG_scadenza_pagamento + " giorni a decorrere dalla data di emissione.";
                }
            }
