...
namespace Publiparking.Core.Data.BD
{
    public class TitoliSMSBD : EntityBD<TitoliSMS>
    {
        ...
        public static TitoliSMS calcolaTitolo(Stalli p_stallo, Int32 p_minuti, DateTime p_dataOraPagamento, DbParkContext p_dbContext)
        {
            TitoliSMS risp = null;
            decimal v_importo = 0;
            ...
            DateTime v_scadenza;
            Tariffe v_tariffa = TariffeBD.GetById(p_dbContext, p_stallo.idTariffa.Value);
            bool v_flat = false;
