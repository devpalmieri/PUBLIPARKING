...
namespace Publiparking.Core.Data.BD.Helper
{
    public static class CFHelper
    {
        private static string trovaCodiceComune(int comune, DbParkContext dbContext)
        {
        ...
        private static string trovaCodiceStatoEstero(string nazione, DbParkContext dbContext)
        {
        ...
        public static string CalcolaCF(string nome, string cognome, string giorno, string mese, string anno, string sesso, string cod_comune, string nazione, DbParkContext dbContext)
        {
        ...
        public static string getCodiceFiscale(DateTime? data_nas, string nome, string cognome, int? cod_comune_nas, string stato_nas, int? id_sesso, DbParkContext dbContext)
        {
